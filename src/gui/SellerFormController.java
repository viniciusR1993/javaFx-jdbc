...
public class SellerFormController implements Initializable {
	...
	private Seller getFormData() {
		...
		if (dpBirthDate.getValue() == null) {
			...
			Instant instant = Instant.from(dpBirthDate.getValue().atStartOfDay(ZoneId.systemDefault()));	//pega o valor que está no DatePicker
	...
	private void initializeNodes() {
		...
		Constraints.setTextFieldDouble(txtBaseSalary); // Define que o txtBaseSalary seja Double
		Constraints.setTextFieldMaxLength(txtEmail, 60); // define tamanho maximo de 60 caracteres para txtName
	...
	public void updateFormData() {
		...
		if (entity.getBirthDate() != null) {
			// usei um código diferente do Udemy devido a atualização do LacalDate não possuir o metodo usei um código
			// diferente do Udemy devido a atualização do LacalDate não possuir o metodo ofInstantofInstant
